...
const Home = () => {
                            ...
                            return (
                                <div className='card card1 col-sm col-lg-4 m-2'>
                                    ...
                                    <div className=' '>
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <h6 class="card-title justify-contant-start">{ele.title}</h6>
                                                <span style={{ color: "#01b2ee" }}>{ele.dis}</span>
                                                <p class="card-text" >{ele.oldDis}</p>
                                            
                                            </div>
                                            <div className='bottomDis row'>
                                                <p class="card-text col-lg-8 col-sm-6 pt-3 text2">{ele.bou}</p>
                                                <div className='price col-lg-4 col-sm-6 row' style={{padding:"0px"}}>
  ...
  <div class="card-body row">
    ...
    <p class="card-text text1">Get the best deals delivered direct to your inbox each day</p>
    </div>
    <div class="input-group col-sm-12 col-lg-6 inp ">
...
{/* ========================================================================================== */}
<div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Featured Auckland deals     <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='row mt-4'>
{
                                ...
                                <div className=' cardSection2 col-sm-6 col-lg-3 mt-3 '>
                                    ...
                                    <div className='test card mx-2'>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div className='bottomDis row'>
                                                <p class="card-text col-lg-8 col-sm-8 pt-4 text2" style={{fontSize:'14px',color:'#92a2ad'}}>{ele.bou}</p>
                                                <div className='price col-lg-3 col-sm-4 ' style={{paddingRight:"20px",marginTop: '10px'}}>
                                                <h5 class="card-text1   " style={{fontSize:'0.8rem'}}><span style={{padding:'15px 8px 0px 0px'}}>{ele.oldPrice}</span><span style={{padding:"0px 0px 0px 0px",fontSize:'1.8rem',color:"#01b2ee"}} > {ele.realPrice}</span>
                                                </h5>
 ...
 <div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Collections   <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Escapes    <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Activiteies, Events & Outdoors    <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='row mt-4'>
{
 ...
 <div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Restaurants, Bars, Cafes  <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Beauty, Massage & Spa   <button class="btn btn-primary " type="button">view more </button></h1>
                                    ...
                                    <div className='test card mx-2'>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div className='bottomDis row'>
                                                ...
                                                <h5 class="card-text1   " style={{fontSize:'0.8rem'}}><span style={{padding:'15px 8px 0px 0px'}}>{ele.oldPrice}</span><span style={{padding:"0px 0px 10px 0px",fontSize:'1.8rem',color:"#01b2ee"}} > {ele.realPrice}</span>
                                                </h5>
...
<div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">House & Garden  <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Fitness & Sports  <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='container-fluid col-11'>
<h1 style={{fontWeight:"650",color:"#4f5864"}} className="mt-4">Automotive <button class="btn btn-primary " type="button">view more </button></h1>
...
<div className='row mt-4'>
{
                    ...
                    {/* <div>
                        <h1 style={{margintop:"200px"}}>yyyyyy</h1>
                    </div> */}
        </>
    )
}
